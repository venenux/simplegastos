...
-- totales de gastos en cada categoria de todas las entidades que realizan gastos

-- consulta para hacer totalizacion de tiendas por categorias, no cruzada, agrupada en una vista
...
-- la cosulta anterior se le aplica otro agrupamiento y ordenamiento final, no se puede en la misma vista
