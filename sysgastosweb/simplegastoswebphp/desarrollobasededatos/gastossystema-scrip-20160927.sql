...
CREATE  TABLE IF NOT EXISTS `gastossystema`.`registro_gastos` (
  ...
  `mon_registro` DECIMAL(20,4) NOT NULL COMMENT 'cuanto se gasto' ,
...
CREATE  TABLE IF NOT EXISTS `gastossystema`.`categoria` (
  `cod_categoria` VARCHAR(40) NOT NULL COMMENT 'YYYYMMDDhhmmss' ,
  `des_categoria` VARCHAR(400) NULL COMMENT 'descripcion_categoria' ,
...
CREATE  TABLE IF NOT EXISTS `gastossystema`.`subcategoria` (
  ...
  `des_subcategoria` VARCHAR(400) NULL COMMENT 'que tipo de gasto en la categoria' ,
...
CREATE  TABLE IF NOT EXISTS `gastossystema`.`registro_adjunto` (
  ...
  `ruta_adjunto` VARCHAR(400) NULL COMMENT 'ruta opcinal del archivo si esta en el sistema de ficheros' ,
  `fecha_adjunto` VARCHAR(40) NULL COMMENT 'cuando se altero este adjunto' ,
  `sessionflag` VARCHAR(40) NULL COMMENT 'esto es quien_registro YYYYMMDDhhmmss + cod_sucursal + . + ficha' ),
  `nam_adjunto` VARCHAR(400) NULL COMMENT 'nombre del archivo despues cargarlo al sistema',
...
CREATE  TABLE IF NOT EXISTS `gastossystema`.`usuarios` (
  ...
  `sessionflag` VARCHAR(40) NULL COMMENT 'esto es quien_registro YYYYMMDDhhmmss + cod_sucursal + . + ficha' ,
  `acc_lectura` VARCHAR(4000) NULL COMMENT 'modulos o pagina controlador que puede leer separados por barra' ,
  `acc_escribe` VARCHAR(4000) NULL COMMENT 'modulos o nombre controlador que puede crear registros separados por barra' ,
  `acc_modifi` VARCHAR(4000) NULL COMMENT 'modulos o nombre controlador que puede alterar separados por barra' ,
...
CREATE  TABLE IF NOT EXISTS `gastossystema`.`entidad` (
  ...
  `des_entidad` VARCHAR(400) NULL COMMENT 'descripcion sucursal' ,
