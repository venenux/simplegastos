...
for(var b=0,c=TableTools._aInstances.length;b<c;b++)if(TableTools._aInstances[b].s.master&&TableTools._aInstances[b].dom.table==a)return TableTools._aInstances[b];return null};TableTools._fnEventListen=function(a,b,c){TableTools._aListeners.push({that:a,type:b,fn:c})};TableTools._fnEventDispatch=function(a,b,c){for(var d=TableTools._aListeners,e=0,f=d.length;e<f;e++)a.dom.table==d[e].that.dom.table&&d[e].type==b&&d[e].fn(c)};TableTools.buttonBase={sAction:"flas_save",sTag:"default",sLinerTag:"default",
sButtonClass:"DTTT_button_xls",sButtonText:"Button text",sTitle:"",sToolTip:"",sCharSet:"utf16",bBomInc:!1,sFileName:"*-exportado.ods.csv",sFieldBoundary:"\"",sFieldSeperator:"\,",sNewLine:"auto",mColumns:"all",bHeader:!0,bFooter:!0,bOpenRows:!1,bSelectedOnly:!1,fnMouseover:null,fnMouseout:null,fnClick:null,fnSelect:null,fnComplete:null,fnInit:null,fnCellRender:null};TableTools.BUTTONS={ods:e.extend({},TableTools.buttonBase,{sAction:"flash_save",sButtonClass:"DTTT_button_xls",sButtonText:"CSV",sFieldBoundary:'"',
sFieldSeperator:"\t",fnClick:function(a,b,c){this.fnSetText(c,this.fnGetTableData(b))}}),ods:e.extend({},TableTools.buttonBase,{sAction:"flash_save",sCharSet:"utf16le",bBomInc:!0,sButtonClass:"DTTT_button_xls",sButtonText:"Excel",fnClick:function(a,b,c){this.fnSetText(c,this.fnGetTableData(b))}}),copy:e.extend({},TableTools.buttonBase,{sAction:"flash_copy",sButtonClass:"DTTT_button_copy",sButtonText:"Copy",fnClick:function(a,b,c){this.fnSetText(c,this.fnGetTableData(b))},fnComplete:function(a,b,c,
