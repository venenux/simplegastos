...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div id='main-table-box' class="main-table-box" style="padding: 0px">
		<table width="100%" cellpadding="0" cellspacing="0" style="border: none; padding: 0px">
			<tr valign="center" style="padding: 0px" >
				<td width="50%" style="border: none; padding: 0px">
					<?php echo form_open( $ajax_list_url, 'method="post" id="filtering_form" class="filtering_form" style="" autocomplete = "off" data-ajax-list-info-url="'.$ajax_list_info_url.'"'); ?>
