...
/**
 * CodeIgniter Date Class
 *
 * This class enables multiple fuction conversions
 *
 * @package		CodeIgniter
 * @subpackage	Libraries
 * @category	Libraries
 * @author		PICCORO Lenz McKAY
 * @link		http://codeigniter.com/user_guide/libraries/date.html
 */
class CI_Date {
	 ...
	 * Constructor
	 *
	 * Loads the date language file and sets the default time reference
	 */
	 ...
	 * @param String $datetime formatted from epoc time
    ...
    // ****************************************************************************
    // TODO: revise seconds validation and Basic Description
    // -----
    // @param
    // @return
    // ****************************************************************************
