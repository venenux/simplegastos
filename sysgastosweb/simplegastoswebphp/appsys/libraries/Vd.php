 ...
 * @original	https://github.com/Spir/vd-dump
 * @license		MIT
 * @version		1.0
 */
class CI_Vd
{
	...
	* @parameter return if true returns formated string, either output html echoed
	* @return if parameter return are TRUE string, either echoes to output html
	*/
...
/* End of file Vd.php */
/* Location: ./appsys/libraries/Vd.php */
