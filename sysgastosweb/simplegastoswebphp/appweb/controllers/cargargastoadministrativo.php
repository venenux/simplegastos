...
class cargargastoadministrativo extends CI_Controller {
	...
	public function gastoregistros()
	{
		...
		{
			$tablaregistros = "registro_gasto_".$usersessid."";
			...
			CREATE OR REPLACE VIEW `".$tablaregistros."` AS
		...
		$crud->unset_delete();
		$crud->required_fields('cod_entidad','cod_categoria','cod_subcategoria','mon_registro','des_concepto','estado','ext_registro');
