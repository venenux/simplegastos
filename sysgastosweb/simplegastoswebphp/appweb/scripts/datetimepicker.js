...
var WindowTitle ="Repositorio del Catalogo: escoja la fecha";//Date Time Picker title.
...
var WeekHeadColor="#eef";//Background Color in Week header.
var SundayColor="#eef";//Background color of Sunday.
...
function NewCal(pCtrl,pFormat,pShowTime,pTimeMode)
{
	...
	winCal=window.open("","DateTimePicker","toolbar=0,status=0,menubar=0,fullscreen=no,width=220,height=280,resizable=0,top="+cnTop+",left="+cnLeft);
...
function RenderCal()
{
	...
	vCalHeader="<table border=1 cellpadding=1 cellspacing=1 width='200px' align=\"center\" valign=\"top\">\n";
	//Month Selector
